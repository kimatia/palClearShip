...
//two
$count = "SELECT * FROM tbl_billoflading  WHERE stackNumber=".$stackNumber." ORDER BY id ASC";
...
$pdf->Cell($width_cell[0],10,$row['stackNumber'],1,0,C,$fill);
$pdf->Cell($width_cell[2],10,$row['billofLadingNumber'],1,0,C,$fill);
$pdf->Cell($width_cell[3],10,$row['shippername'],1,0,C,$fill);
$pdf->Cell($width_cell[4],10,$row['shipperadress'],1,1,C,$fill);
