...
$row = $stmt->fetch(PDO::FETCH_ASSOC);
  ...
  $message = $_POST['message'];// user content
  ...
  $hashedChatId=$_POST['hashedChatTotalIdentity'];
        ...
        if(!isset($errMSG))
        {
            $stmtttt = $DB_con->prepare('INSERT INTO tbl_palmmessages(mid,sid,totalUniqueChatId,uniqueHashedChatId  ,chatFrom,chatTo,message, chatTime) VALUES(:mid,:sid,:tchat,:hchat,:cfrom,:cto,:mess,:timee)');
