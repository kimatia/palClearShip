...
$_SESSION['infobol'] = $_GET['id'];
$y = $_SESSION['infobol'];
$respFileBol = $con->query("SELECT * FROM tbl_billoflading WHERE id='$y'");
$rowFileBol=$respFileBol->fetch_array();
$bolFileStackNo=$rowFileBol['stackNumber'];
...
//final date time for bol file
// replace function for post date
$stringBolFinalDate = $bolPostDate;
$replacedBolFinalDate=str_replace($arrFrom, $arrTo, $stringBolFinalDate);
//check if AM or PM? then perform action.
$stringBolPostTime = $bolPostTime;
if (strpos($stringBolPostTime, 'P') !== false) {
 // rtrim function for PM time
$stringBolTime = $bolPostTime;
$trimmedBolPostTime=rtrim($stringBolTime, "PM.");
}elseif(strpos($stringBolPostTime,'A') !==false){
  // rtrim function for AM time
$stringBolTime = $bolPostTime;
$trimmedBolPostTime=rtrim($stringBolTime, "AM.");
}
...
$finalBolFullDateTime=$replacedBolFinalDate." ".$trimmedBolPostTime;
...
//date finction to calculate difference
   ...
   $strEndBol   = $finalBolFullDateTime; 
...
<div class="panel panel-primary">
 ...
 <span class="pull-right text-muted small"><em><?php echo $bolPostedDate ?></em>
 </span>
 </a>
 <a href="#" class="list-group-item">
 ...
 <a href="#" class="list-group-item">
 <i class="icon-upload"></i>Bill of Lading No.:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em><hh style="color: grey;"><?php echo $bolNumber;?></hh></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shipper Name:
