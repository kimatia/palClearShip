...
$y = $_SESSION['infoIdf'];
$respFileInvoice = $con->query("SELECT * FROM tbl_invoice WHERE id='$y'");
$rowFileInvoice=$respFileInvoice->fetch_array();
$bolFileStackNo=$rowFileInvoice['stackNumber'];
$invoiceNumber=$rowFileInvoice['invoiceNo'];
$invoicePostTime=$rowFileInvoice['postTime'];
$invoicePostDate=$rowFileInvoice['postDate'];
$invoicePostedDate=$invoicePostDate." ".$invoicePostTime;
$z=$bolFileStackNo;
...
//final date time for invoice file
// replace function for post date
$stringInvoiceFinalDate = $invoicePostDate;
$replacedInvoiceFinalDate=str_replace($arrFrom, $arrTo, $stringInvoiceFinalDate);
//check if AM or PM? then perform action.
$stringInvoicePostTime = $invoicePostTime;
if (strpos($stringInvoicePostTime, 'P') !== false) {
 // rtrim function for PM time
$stringInvoiceTime = $invoicePostTime;
$trimmedInvoicePostTime=rtrim($stringInvoiceTime, "PM.");
}elseif(strpos($stringInvoicePostTime,'A') !==false){
  // rtrim function for AM time
$stringInvoiceTime = $invoicePostTime;
$trimmedInvoicePostTime=rtrim($stringInvoiceTime, "AM.");
}
...
$finalInvoiceFullDateTime=$replacedInvoiceFinalDate." ".$trimmedInvoicePostTime;
...
//date finction to calculate difference
   ...
   $strEndBol   = $finalInvoiceFullDateTime; 
...
<div class="panel panel-primary">
 ...
 <span class="pull-right text-muted small"><em><?php echo $invoicePostedDate ?></em>
 </span>
 </a>
 <a href="#" class="list-group-item">
 ...
 <a href="#" class="list-group-item">
 <i class="icon-upload"></i>Invoice Form. No.:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em><hh style="color: grey;"><?php echo $invoiceNumber;?></hh></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shipper Name:
