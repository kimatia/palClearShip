...
$_SESSION['infoKra'] = $_GET['id'];
$y = $_SESSION['infoKra'];
$respFileKra = $con->query("SELECT * FROM tbl_treciept WHERE id='$y'");
$rowFileKra=$respFileKra->fetch_array();
$bolFileStackNo=$rowFileKra['stackNumber'];
$kraNumber=$rowFileKra['trecieptNo'];
$kraPostTime=$rowFileKra['postTime'];
$kraPostDate=$rowFileKra['postDate'];
$kraPostedDate=$kraPostDate." ".$kraPostTime;
$z=$bolFileStackNo;
...
$bolFile="Kenya Revenue Authority";
if($status=="Yes"){
$fileStatus="Closed";  
}elseif($status=="No"){
$fileStatus="Active";  
...
//final date time for Kra file
// replace function for post date
$stringKraFinalDate = $kraPostDate;
$replacedKraFinalDate=str_replace($arrFrom, $arrTo, $stringKraFinalDate);
//check if AM or PM? then perform action.
$stringKraPostTime = $kraPostTime;
if (strpos($stringKraPostTime, 'P') !== false) {
 // rtrim function for PM time
$stringKraTime = $kraPostTime;
$trimmedKraPostTime=rtrim($stringKraTime, "PM.");
}elseif(strpos($stringKraPostTime,'A') !==false){
  // rtrim function for AM time
$stringKraTime = $kraPostTime;
$trimmedKraPostTime=rtrim($stringKraTime, "AM.");
}
...
$finalKraFullDateTime=$replacedKraFinalDate." ".$trimmedKraPostTime;
...
//date finction to calculate difference
   ...
   $strEndBol   = $finalKraFullDateTime; 
...
<div class="panel panel-primary">
 ...
 <span class="pull-right text-muted small"><em><?php echo $kraPostedDate ?></em>
 </span>
 </a>
 <a href="#" class="list-group-item">
 ...
 <a href="#" class="list-group-item">
 <i class="icon-upload"></i>Kenya Revenue. No.:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em><hh style="color: grey;"><?php echo $kraNumber;?></hh></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shipper Name:
