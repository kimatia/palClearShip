...
$_SESSION['infoQuadruplicate'] = $_GET['id'];
$y = $_SESSION['infoQuadruplicate'];
$respFileQuadruplicate = $con->query("SELECT * FROM tbl_quadruplicate WHERE id='$y'");
$rowFileQuadruplicate=$respFileQuadruplicate->fetch_array();
$bolFileStackNo=$rowFileQuadruplicate['stackNumber'];
$quadruplicateNumber=$rowFileQuadruplicate['quadruplicateNo'];
$quadruplicatePostTime=$rowFileQuadruplicate['postTime'];
$quadruplicatePostDate=$rowFileQuadruplicate['postDate'];
$quadruplicatePostedDate=$quadruplicatePostDate." ".$quadruplicatePostTime;
$z=$bolFileStackNo;
...
//final date time for Quadruplicate file
// replace function for post date
$stringQuadruplicateFinalDate = $quadruplicatePostDate;
$replacedQuadruplicateFinalDate=str_replace($arrFrom, $arrTo, $stringQuadruplicateFinalDate);
//check if AM or PM? then perform action.
$stringQuadruplicatePostTime = $quadruplicatePostTime;
if (strpos($stringQuadruplicatePostTime, 'P') !== false) {
 // rtrim function for PM time
$stringQuadruplicateTime = $quadruplicatePostTime;
$trimmedQuadruplicatePostTime=rtrim($stringQuadruplicateTime, "PM.");
}elseif(strpos($stringQuadruplicatePostTime,'A') !==false){
  // rtrim function for AM time
$stringQuadruplicateTime = $quadruplicatePostTime;
$trimmedQuadruplicatePostTime=rtrim($stringQuadruplicateTime, "AM.");
}
...
//date finction to calculate difference
   ...
   $strEndBol   = $finalQuadruplicateFullDateTime; 
...
<div class="panel panel-primary">
 ...
 <span class="pull-right text-muted small"><em><?php echo $quadruplicatePostedDate ?></em>
 </span>
 </a>
 <a href="#" class="list-group-item">
 ...
 <a href="#" class="list-group-item">
 <i class="icon-upload"></i>Quadruplicate. No.:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em><hh style="color: grey;"><?php echo $quadruplicateNumber;?></hh></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shipper Name:
