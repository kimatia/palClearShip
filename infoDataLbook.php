...
$_SESSION['infoLbook'] = $_GET['id'];
$y = $_SESSION['infoLbook'];
$respFileLbook = $con->query("SELECT * FROM tbl_lbook WHERE id='$y'");
$rowFileLbook=$respFileLbook->fetch_array();
$bolFileStackNo=$rowFileLbook['stackNumber'];
$lbookNumber=$rowFileLbook['lbookNo'];
$lbookPostTime=$rowFileLbook['postTime'];
$lbookPostDate=$rowFileLbook['postDate'];
$lbookPostedDate=$lbookPostDate." ".$lbookPostTime;
$z=$bolFileStackNo;
...
//final date time for Lbook file
// replace function for post date
$stringLbookFinalDate = $lbookPostDate;
$replacedLbookFinalDate=str_replace($arrFrom, $arrTo, $stringLbookFinalDate);
//check if AM or PM? then perform action.
$stringLbookPostTime = $lbookPostTime;
if (strpos($stringLbookPostTime, 'P') !== false) {
 // rtrim function for PM time
$stringLbookTime = $lbookPostTime;
$trimmedLbookPostTime=rtrim($stringLbookTime, "PM.");
}elseif(strpos($stringLbookPostTime,'A') !==false){
  // rtrim function for AM time
$stringLbookTime = $lbookPostTime;
$trimmedLbookPostTime=rtrim($stringLbookTime, "AM.");
}
...
$finalLbookFullDateTime=$replacedLbookFinalDate." ".$trimmedLbookPostTime;
...
//date finction to calculate difference
   ...
   $strEndBol   = $finalLbokFullDateTime; 
...
<div class="panel panel-primary">
 ...
 <span class="pull-right text-muted small"><em><?php echo $lbookPostedDate ?></em>
 </span>
 </a>
 <a href="#" class="list-group-item">
 ...
 <a href="#" class="list-group-item">
 <i class="icon-upload"></i>Log Book. No.:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em><hh style="color: grey;"><?php echo $lbookNumber;?></hh></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shipper Name:
