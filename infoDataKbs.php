...
$_SESSION['infoKbs'] = $_GET['id'];
$y = $_SESSION['infoKbs'];
$respFileKbs = $con->query("SELECT * FROM tbl_kbs WHERE id='$y'");
$rowFileKbs=$respFileKbs->fetch_array();
$bolFileStackNo=$rowFileKbs['stackNumber'];
$kbsNumber=$rowFileKbs['kbsNo'];
$kbsPostTime=$rowFileKbs['postTime'];
$kbsPostDate=$rowFileKbs['postDate'];
$kbsPostedDate=$kbsPostDate." ".$kbsPostTime;
$z=$bolFileStackNo;
...
$bolFile="Kenya Bureau Standards";
if($status=="Yes"){
$fileStatus="Closed";  
}elseif($status=="No"){
$fileStatus="Active";  
...
//final date time for kbs file
// replace function for post date
$stringKbsFinalDate = $kbsPostDate;
$replacedKbsFinalDate=str_replace($arrFrom, $arrTo, $stringKbsFinalDate);
//check if AM or PM? then perform action.
$stringKbsPostTime = $kbsPostTime;
if (strpos($stringKbsPostTime, 'P') !== false) {
 // rtrim function for PM time
$stringKbsTime = $kbsPostTime;
$trimmedKbsPostTime=rtrim($stringKbsTime, "PM.");
}elseif(strpos($stringKbsPostTime,'A') !==false){
  // rtrim function for AM time
$stringKbsTime = $kbsPostTime;
$trimmedKbsPostTime=rtrim($stringKbsTime, "AM.");
}
...
$finalKbsFullDateTime=$replacedKbsFinalDate." ".$trimmedKbsPostTime;
...
//date finction to calculate difference
   ...
   $strEndBol   = $finalKbsFullDateTime; 
...
<div class="panel panel-primary">
 ...
 <span class="pull-right text-muted small"><em><?php echo $kbsPostedDate ?></em>
 </span>
 </a>
 <a href="#" class="list-group-item">
 ...
 <a href="#" class="list-group-item">
 <i class="icon-upload"></i>Kenya Bureau. No.:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em><hh style="color: grey;"><?php echo $kbsNumber;?></hh></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shipper Name:
