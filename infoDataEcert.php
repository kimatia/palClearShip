...
$_SESSION['infoEcert'] = $_GET['id'];
$y = $_SESSION['infoEcert'];
$respFileEcert = $con->query("SELECT * FROM tbl_ecert WHERE id='$y'");
$rowFileEcert=$respFileEcert->fetch_array();
$bolFileStackNo=$rowFileEcert['stackNumber'];
$ecertNumber=$rowFileEcert['ecertNo'];
$ecertPostTime=$rowFileEcert['postTime'];
$ecertPostDate=$rowFileEcert['postDate'];
$ecertPostedDate=$ecertPostDate." ".$ecertPostTime;
$z=$bolFileStackNo;
...
//final date time for Ecert file
// replace function for post date
$stringEcertFinalDate = $ecertPostDate;
$replacedEcertFinalDate=str_replace($arrFrom, $arrTo, $stringEcertFinalDate);
//check if AM or PM? then perform action.
$stringEcertPostTime = $ecertPostTime;
if (strpos($stringEcertPostTime, 'P') !== false) {
 // rtrim function for PM time
$stringEcertTime = $ecertPostTime;
$trimmedEcertPostTime=rtrim($stringEcertTime, "PM.");
}elseif(strpos($stringEcertPostTime,'A') !==false){
  // rtrim function for AM time
$stringEcertTime = $ecertPostTime;
$trimmedEcertPostTime=rtrim($stringEcertTime, "AM.");
}
...
$finalEcertFullDateTime=$replacedEcertFinalDate." ".$trimmedEcertPostTime;
...
//date finction to calculate difference
   ...
   $strEndBol   = $finalEcertFullDateTime; 
...
<div class="panel panel-primary">
 ...
 <span class="pull-right text-muted small"><em><?php echo $ecertPostedDate ?></em>
 </span>
 </a>
 <a href="#" class="list-group-item">
 ...
 <a href="#" class="list-group-item">
 <i class="icon-upload"></i>Export Cert No.:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em><hh style="color: grey;"><?php echo $ecertNumber;?></hh></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shipper Name:
