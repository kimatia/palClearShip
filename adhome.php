...
if (isset($_GET['editentry'])){
  $_SESSION['editentry'] = $_GET['editentry'];
  $_SESSION['editfile'] = "Entry";
  header("location: editFile.php");
}
...
if($rowStack['bol']=="Yes"){
?>
<label title="Bill of Lading"><li class="active"><a href="#<?php echo "tab_a".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">BOL</pp></span></strong></a></li></label>
<?php
}elseif ($rowStack['bol']=="No") {
 ?>
<label title="Bill of Lading"><li class="active"><a href="#<?php echo "tab_a".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">BOL</pp></span></strong></a></li></label>
 <?php
}if($rowStack['idf']=="Yes"){
?>
<label title="Import Declaration Form"><li><a href="#<?php echo "tab_b".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">IDF</pp></span></strong></a></li></label>
 <?php
}elseif ($rowStack['idf']=="No") {
 ?>
<label title="Import Declaration Form"><li><a href="#<?php echo "tab_b".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">IDF</pp></span></strong></a></li></label>
 <?php
}if($rowStack['coi']=="Yes"){
?>
<label title="Certificate of Inspection"><li><a href="#<?php echo "tab_c".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">COI</pp></span></strong></a></li></label>
 <?php
}elseif ($rowStack['coi']=="No") {
  ?>
<label title="Certificate of Inspection"><li><a href="#<?php echo "tab_c".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">COI</pp></span></strong></a></li></label>
 <?php
}if($rowStack['ecert']=="Yes"){
?>
<label title="Japanese Logbook"><li><a href="#<?php echo "tab_d".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">JLB</pp></span></strong></a></li></label>
 <?php
}elseif ($rowStack['ecert']=="No") {
  ?>
<label title="Japanese Logbook"><li><a href="#<?php echo "tab_d".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">JLB</pp></span></strong></a></li></label>
 <?php
}if($rowStack['treciept']=="Yes"){
?>
<label title="Kenya Revenue Authority"><li><a href="#<?php echo "tab_e".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">KRA</pp></span></strong></a></li></label>
 <?php
}elseif ($rowStack['treciept']=="No") {
 ?>
<label title="Kenya Revenue Authority"><li><a href="#<?php echo "tab_e".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">KRA</pp></span></strong></a></li></label>
 <?php
}
if($rowStack['entry']=="Yes"){
?>
<label title="Entry Form"><li><a href="#<?php echo "tab_g".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">ENT</pp></span></strong></a></li></label>
<?php
}elseif ($rowStack['entry']=="No") {
 ?>
<label title="Entry Form"><li><a href="#<?php echo "tab_g".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">ENT</pp></span></strong></a></li></label>
<?php
}
if($rowStack['lbook']=="Yes"){
?>
<label title="Log Book"><li><a href="#<?php echo "tab_f".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">LBK</pp></span></strong></a></li></label>
 <?php
}elseif ($rowStack['lbook']=="No") {
  ?>
<label title="Log Book"><li><a href="#<?php echo "tab_f".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">LBK</pp></span></strong></a></li></label>
 <?php
}
?>
</ul>
            ...
            <p><?php
                  ...
                  $rowUserName=$respUserName->fetch_array();
                   ...
                   if($rowStack['bol']=="Yes"){
                    ...
                    <!-- method 2 iframe -->
                    <iframe src="upload/<?php echo $rowFileImage['billofLading_file']; ?>" style="width: 410px; height:320px;" frameborder="1"></iframe>
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>
                 &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?editbol=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a>
</a></span>
</center>
                    <?php
                  }else{
                   ...
                   <div class="row">
                      <div class="col-md-12">
                      <center>
                         <p style="text-align: center;" ><a href="?addBOL=<?php echo $rowStack['stackNumber'];?>" class="fa fa-file" style="font-size:345px"></a></p>
                         </center>
                      </div>
        ...
        <div class="tab-pane fade" id="<?php echo "tab_b".$rand; ?>">
            <p><?php
                  //get file image
                  ...
                  if($rowStack['idf']=="Yes"){
                   ...
                   <!-- method 1 embed -->
                    <!-- <embed src="" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"> -->
                    <!-- method 2 iframe -->
                    <iframe src="upload/<?php echo $rowFileImage['idf_file']; ?>" style="width: 410px; height:320px;" frameborder="1"></iframe>
                 </a>
                 &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>

                   &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?editidf=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a>
</a></span>
         </center>
                           <?php
                 }else{
        ...
        <div class="tab-pane fade" id="<?php echo "tab_c".$rand; ?>">
            <p><?php
                  ...
                  $rowUserName=$respUserName->fetch_array();
                   ...
                   if($rowStack['coi']=="Yes"){
                    ...
                    <!-- <embed src="" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"> -->
                    <!-- method 2 iframe -->
                    <iframe src="upload/<?php echo $rowFileImage['coi_file']; ?>" style="width: 410px; height:320px;" frameborder="1"></iframe>
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>
                   &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?editcoi=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a>
</a></span>
                </center>
                            <?php
                  }else{
        ...
        <div class="tab-pane fade" id="<?php echo "tab_d".$rand; ?>">
            <p><?php //get file image
                  ...
                  if($rowStack['ecert']=="Yes"){
                    ...
                    <!-- <embed src="" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"> -->
                    <!-- method 2 iframe -->
                    <iframe src="upload/<?php echo $rowFileImage['ecert_file']; ?>" style="width: 410px; height:320px;" frameborder="1"></iframe>
                  </a>
                  &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>
                 &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?editecert=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a>
</a></span>
               </center>
                            <?php
                  }else{
        ...
        <div class="tab-pane fade" id="<?php echo "tab_e".$rand; ?>">
            <p><?php
                  //get file image
                  ...
                  $rowUserName=$respUserName->fetch_array();
                   ...
                   if($rowStack['treciept']=="Yes"){
                    ...
                    <iframe src="upload/<?php echo $rowFileImage['treciept_file']; ?>" style="width: 410px; height:320px;" frameborder="1"></iframe>

                  </a>
                  &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>
                  &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?edittreciept=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a></span>
             </center>
                            <?php
                  }else{
                    ?>
        ...
        <div class="tab-pane fade" id="<?php echo "tab_g".$rand; ?>">
            <p><?php

                  //get file image
                  $respFileImage = $con->query("SELECT * FROM tbl_entry WHERE stackNumber='$num'");
                  if($respFileImage){
                    $rowFileImage=$respFileImage->fetch_array();
                  }
                  ...
                  $rowUserName=$respUserName->fetch_array();
                   ...
                   if($rowStack['entry']=="Yes"){
                     $str=$rowFileImage['entryNo'];
                    $strentry = strtoupper($str);
                    ?>
                    <center>
                     <div class="row">
                      <div class="col-md-6">
                         <h5 style="font-size: 13px;"><strong>Entry Form</strong></h5>
                      </div>
                      <div class="col-md-6">
                         <h5 style="font-size: 13px;"><strong>No.<?php echo $strentry; ?></strong></h5>
                      </div>
                    </div>
                    
                    
                    <a href="#" data-toggle="modal" data-target="#displayentry<?php echo $x; ?>">
                    <!-- method 1 embed -->
                    <!-- <embed src="" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"> -->
                    <!-- method 2 iframe -->
                    <iframe src="upload/<?php echo $rowFileImage['entry_file']; ?>" style="width: 410px; height:320px;" frameborder="1"></iframe>
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>
                   &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?editentry=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a>
</a></span>
                  </center>
                            <?php
                  }else{
                    ...
                    <center>
                  <a href="?addEntry=<?php echo $rowStack['stackNumber'];?>" class="fa fa-file" style="font-size:345px"></a>
                    </center>
                  <?php }?></p>
        </div>
        <div class="tab-pane fade" id="<?php echo "tab_f".$rand; ?>">
            <p><?php
                  ...
                  $rowUserName=$respUserName->fetch_array();
                   ...
                   if($rowStack['lbook']=="Yes"){
                    ...
                    <!-- <embed src="" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"> -->
                    <!-- method 2 iframe -->
                    <iframe src="upload/<?php echo $rowFileImage['lbook_file']; ?>" style="width: 410px; height:320px;" frameborder="1"></iframe>
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>
                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?editlbook=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a></span>
     </center>
                            <?php
                  }else{
                    ?>
...
?>
<label title="Invoice Form"><li><a href="#<?php echo "tab_c".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">INV</pp></span></strong></a></li></label>
<?php
}elseif ($rowStack['invoice']=="No") {
?>
<label title="Invoice Form"><li><a href="#<?php echo "tab_c".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">INV</pp></span></strong></a></li></label>
<?php
}if($rowStack['pkl']=="Yes"){
?>
<label title="Packaging List"><li><a href="#<?php echo "tab_d".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">PGL</pp></span></strong></a></li></label>
<?php
}elseif ($rowStack['pkl']=="No") {
 ?>
<label title="Packaging List"><li><a href="#<?php echo "tab_d".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">PGL</pp></span></strong></a></li></label>
<?php
}if($rowStack['idf']=="Yes"){
?>
<label title="Import Declaration Form"><li><a href="#<?php echo "tab_b".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">IDF</pp></span></strong></a></li></label>
...
if($rowStack['coc']=="Yes"){
?>
<label title="Certificate of Conformity"><li><a href="#<?php echo "tab_e".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">COC</pp></span></strong></a></li></label>
<?php
}elseif ($rowStack['coc']=="No") {
 ?>
<label title="Certificate of Conformity"><li><a href="#<?php echo "tab_e".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">COC</pp></span></strong></a></li></label>
<?php
}if($rowStack['treciept']=="Yes"){
?>
<label title="Kenya Revenue Authority"><li><a href="#<?php echo "tab_f".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: blue;"><pp style="color: black;">KRA</pp></span></strong></a></li></label>
<?php
}elseif ($rowStack['treciept']=="No") {
 ?>
<label title="Kenya Revenue Authority"><li><a href="#<?php echo "tab_f".$rand; ?>" class="btn btn-default btn-sm" data-toggle="pill"><strong><span class="fa fa-check" style="color: black;"><pp style="color: black;">KRA</pp></span></strong></a></li></label>
<?php
}
if($rowStack['entry']=="Yes"){
?>
...
<div class="tab-content" style="overflow-y: 400px;">
        <div class="tab-pane active" id="<?php echo "tab_a".$rand; ?>">
             <p><?php
                  //get file image
                  $respFileImage = $con->query("SELECT * FROM tbl_billoflading WHERE stackNumber='$num'");
...
<span><a href="?editbol=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a>
                   ...
                   <div class="row">
                      <div class="col-md-12">
                      <p style="text-align: center;"><a href="?addBOL=<?php echo $rowStack['stackNumber'];?>"  style="font-size:345px"><span style="text-align: center; display: inline-block;" class="fa fa-file" aria-hidden="true"></span></a></p>
        ...
        <div class="tab-pane fade" id="<?php echo "tab_c".$rand; ?>">
            <p><?php
                  ...
                  if($rowStack['invoice']=="Yes"){
                    ...
                    <!-- <embed src="" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"> -->
                    <!-- method 2 iframe -->
                    <iframe src="upload/<?php echo $rowFileImage['invoice_file']; ?>" style="width: 410px; height:320px;" frameborder="1"></iframe>
                  </a>
                  &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>
                   &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?editinvoice=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a>
</a></span>
              </center>
                      <?php
                  }else{
            ...
            <p><?php
                  ...
                  if($rowStack['pkl']=="Yes"){
                   ...
                   <!-- method 1 embed -->
                    <!-- <embed src="" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"> -->
                    <!-- method 2 iframe -->
                    <iframe src="upload/<?php echo $rowFileImage['pkl_file']; ?>" style="width: 410px; height:320px;" frameborder="1"></iframe>
                 </a>
                 &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>

                   &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?editpkl=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a>
</a></span>
             </center>
                           <?php
                 }else{
            ...
            <p><?php
                  ...
                  $rowUserName=$respUserName->fetch_array();
                   ...
                   if($rowStack['coc']=="Yes"){
                    ...
                    <!-- <embed src="" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"> -->
                    <!-- method 2 iframe -->
                    <iframe src="upload/<?php echo $rowFileImage['coc_file']; ?>" style="width: 410px; height:320px;" frameborder="1"></iframe>
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>
                   &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?editcoc=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a>
</a></span>
            </center>
                            <?php
                  }else{
        ...
        <div class="tab-pane fade" id="<?php echo "tab_f".$rand; ?>">
            <p><?php
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user"><?php echo $rowUserName['userName'];?></span>
                  &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-clock-o"><?php echo $rowFileImage['postTime'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;
<span><a href="?edittreciept=<?php echo $rowFileImage['id']; ?>" class="fa fa-pencil"> Edit</a>
</a></span>
</center>
                            <?php
                  }else{
