...
$_SESSION['infoCoc'] = $_GET['id'];
$y = $_SESSION['infoCoc'];
$respFileCoc = $con->query("SELECT * FROM tbl_coc WHERE id='$y'");
$rowFileCoc=$respFileCoc->fetch_array();
$bolFileStackNo=$rowFileCoc['stackNumber'];
$cocNumber=$rowFileCoc['cocNo'];
$cocPostTime=$rowFileCoc['postTime'];
$cocPostDate=$rowFileCoc['postDate'];
$cocPostedDate=$cocPostDate." ".$cocPostTime;
$z=$bolFileStackNo;
...
//final date time for Coc file
// replace function for post date
$stringCocFinalDate = $cocPostDate;
$replacedCocFinalDate=str_replace($arrFrom, $arrTo, $stringCocFinalDate);
//check if AM or PM? then perform action.
$stringCocPostTime = $cocPostTime;
if (strpos($stringCocPostTime, 'P') !== false) {
 // rtrim function for PM time
$stringCocTime = $cocPostTime;
$trimmedCocPostTime=rtrim($stringCocTime, "PM.");
}elseif(strpos($stringCocPostTime,'A') !==false){
  // rtrim function for AM time
$stringCocTime = $cocPostTime;
$trimmedCocPostTime=rtrim($stringCocTime, "AM.");
}
...
$finalCocFullDateTime=$replacedCocFinalDate." ".$trimmedCocPostTime;
...
//date finction to calculate difference
   ...
   $strEndBol   = $finalCocFullDateTime; 
...
<div class="panel panel-primary">
 ...
 <span class="pull-right text-muted small"><em><?php echo $cocPostedDate ?></em>
 </span>
 </a>
 <a href="#" class="list-group-item">
 ...
 <a href="#" class="list-group-item">
 <i class="icon-upload"></i>Conformity . No.:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em><hh style="color: grey;"><?php echo $cocNumber;?></hh></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shipper Name:
